...
<nav>
<ul class="topnav">
  <li><a class="li1" href="#">H</a></li>
  <li><a href="#" class="li2" onclick="alert('Página En Construcción');">O</a></li>
  <li><a href="#" class="li3" onclick="alert('Página En Construcción');">L</a></li>
  <li class="li4"><a href="#">A</a></li>
</ul>
</nav>
<article>
...
<div class="container">
  ...
  <form action="/action_page.php">
    ...
    <div class="row">
      ...
      <div class="respuesta">
        <select id="country" name="country">
          <option value="australia">Aprendiz</option>
          <option value="canada">Instructor</option>
          <option value="usa">Empresa</option>
        </select>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="respuesta">
        <select id="country" name="country">
          ...
          <option value="canada">Mujer</option>
        </select>
      </div>
    </div>
	...
	<div class="row">
      ...
      <div class="respuesta">
        <select id="country" name="country">
          <option value="australia">TI</option>
          <option value="canada">CC</option>
        </select>
      </div>
    </div>
	...
	<div class="row">
	      ...
	      <div class="respuesta">
	        <input type="text" id="lname" name="lastname" placeholder="Tu Documento...">
	      </div>
	    </div>
    ...
    <div class="row">
      ...
      <div class="respuesta">
        <input type="text" id="lname" name="lastname" placeholder="Tu Celular...">
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="respuesta">
        <input type="text" id="lname" name="lastname" placeholder="Tu Teléfono...">
      </div>
    </div>
...
<center>
    ...
    <div class="row">
      <input class="facebook" type="submit" value="Refistrarse Con Facebook">
    </div>
    <div class="row">
...
<footer>
<a href="#"><img src="https://png2.kisspng.com/20180403/jre/kisspng-social-media-facebook-linkedin-estate-agent-comput-background-black-5ac30b66c0cbe5.7533974715227318787897.png"></a>
<a href="#"><img src="https://image.flaticon.com/icons/png/512/69/69366.png"></a>
<a href="#"><img src="https://banner2.kisspng.com/20180326/gxq/kisspng-github-computer-icons-icon-design-github-5ab8a31e334e73.4114704215220498222102.jpg"></a>
<a href="#"><img src="http://www.myiconfinder.com/uploads/iconsets/3c9eaa4c8dd944eade4d976497f7c5e9.png"></a>
</footer>
</body>
</html>